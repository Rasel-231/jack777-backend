...
const MasterAdminValidation = z.object({
    body: z.object({
...
const MasterAdminaUpdateValidation = z.object({
    body: z.object({
...
export const MasterAdminZodValidations = {
    MasterAdminValidation,
    MasterAdminaUpdateValidation
} 